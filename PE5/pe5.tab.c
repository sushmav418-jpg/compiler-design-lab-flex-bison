...
{
       0,   114,   114,   139,   140,   141,   142,   143,   144,   145
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DIV", "LPAREN", "RPAREN", "$accept", "input", "expr", 0
};
#endif
...
#line 114 "pe5.y"
    {
          ...
          printTreeRoot((yyvsp[(1) - (1)].node));

          printf("\n------------------------------\n");
          printf("Preorder  (Root->Left->Right) : ");
          preorder((yyvsp[(1) - (1)].node));

          printf("\nInorder   (Left->Root->Right) : ");
          inorder((yyvsp[(1) - (1)].node));

          printf("\nPostorder (Left->Right->Root) : ");
          postorder((yyvsp[(1) - (1)].node));
...
/* Line 1455 of yacc.c  */
#line 144 "pe5.y"
    { (yyval.node) = newNode((yyvsp[(1) - (1)].str), NULL, NULL); ;}
    break;
